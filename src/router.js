...
const router = new Router({
    ...
    // =============================================================================
            ...
            children: [
        // =============================================================================
        // 6D - Report System Menu
        // =============================================================================
            {
                path: '/app-system/parameter-config',
                name: 'appSystemParameterConfig',
                component: () => import('./views/app-system/ParameterConfig.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/app-system/audit-trail',
                name: 'appSystemAuditTrail',
                component: () => import('./views/app-system/AuditTrail.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/internal-access/app-role',
                name: 'internalAccessAppRole',
                component: () => import('./views/internal-access/AppRole.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/internal-access/app-user',
                name: 'internalAccessAppUser',
                component: () => import('./views/internal-access/AppUser.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/internal-access/organization-unit',
                name: 'internalAccessOrganizationUnit',
                component: () => import('./views/internal-access/OrganizationUnit.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/project-maintenance/job-list',
                name: 'projectAccessProjectMaintenanceJobList',
                component: () => import('./views/project-maintenance/JobList.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/project-maintenance/project-definition',
                name: 'projectAccessProjectMaintenanceProjectDefinition',
                component: () => import('./views/project-maintenance/ProjectDefinition.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/client-maintenance/client-registration',
                name: 'projectAccessClientMaintenanceClientRegistration',
                component: () => import('./views/project-access/client-maintenance/ClientRegistration.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/client-maintenance/report-setup',
                name: 'projectAccessClientMaintenanceReportSetup',
                component: () => import('./views/project-access/client-maintenance/ReportSetup.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/client-maintenance/user-client-access',
                name: 'projectAccessClientMaintenanceUserClientAccess',
                component: () => import('./views/project-access/client-maintenance/UserClientAccess.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/executor-maintenance/executor-registration',
                name: 'projectAccessExecutorMaintenanceExecutorRegistration',
                component: () => import('./views/project-access/executor-maintenance/ExecutorRegistration.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/executor-maintenance/user-executor-access',
                name: 'projectAccessExecutorMaintenanceUserExecutorAccess',
                component: () => import('./views/project-access/executor-maintenance/UserExecutorAccess.vue'),
                meta: {
                    rule: 'admin'
                }
            },
            {
                path: '/project-access/executor-maintenance/group-user-executor',
                name: 'projectAccessExecutorMaintenanceGroupUserExecutor',
                component: () => import('./views/project-access/executor-maintenance/GroupUserExecutor.vue'),
                meta: {
                    rule: 'admin'
                }
            },
    ...
    // =============================================================================
        ...
        // =============================================================================
                ...
                {
                    path: '/pages/login/client',
                    name: 'pageLoginClient',
                    component: () => import('@/views/pages/ClientLogin.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                ...
                },
                {
                    ...
                    name: 'pageSelection',
                    component: () => import('@/views/pages/Selection.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
        ...
        {
            path:'',
            component:()=>import('@/layouts/executor/ExecutorPage.vue'),
            children:[
                {
                    path: '/executor/dashboard',
                    name: "executorDashboard",
                    component: () =>import('./views/executor/Dashboard.vue'),
                    meta: {
                        rule:'admin'
                    }
                },
                {
                    path: '/executor/jobdetail/:id',
                    name: "executorJobDetail",
                    component: () =>import('./views/executor/JobDetail.vue'),
                    meta: {
                        rule:'admin'
                    }
                },
                {
                    path: '/executor/reportdetail/:id',
                    name: "executorReportDetail",
                    component: () =>import('./views/executor/ReportDetail.vue'),
                    meta: {
                        rule:'admin'
                    }
                },
                {
                    path: '/executor/project/',
                    name: "executorProject",
                    component: () =>import('./views/executor/Project.vue'),
                    meta: {
                        rule:'admin'
                    }
                },
                {
                    path: '/executor/projectdetail/:id',
                    name: "executorProjectDetail",
                    component: () =>import('./views/executor/ProjectDetail.vue'),
                    meta: {
                        rule:'admin'
                    }
                },
...
router.beforeEach((to, from, next) => {
    if (
        to.path === "/pages/login" ||
        to.path === "/pages/login/client" ||
        to.path === "/pages/forgot-password" ||
        to.path === "/pages/error-404" ||
        to.path === "/pages/error-500" ||
        to.path === "/pages/register" ||
        to.path === "/callback" ||
        to.path === "/pages/comingsoon" ||auth.isAuthenticated()
    ) {
        return next();
    }
