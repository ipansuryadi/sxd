  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="dataTable">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="project_ongoing">Project Ongoing</vs-th>
        <vs-th sort-key="project_done">Total Project Done</vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="product-category">{{ tr.project_ongoing }}</p>
              </vs-td>

              <vs-td>
                <p class="product-category">{{ tr.project_done }}</p>
              </vs-td>
...
<script>
import AddNewDataSidebar from './AddNewDataExecutorRegistrationSidebar.vue';
...
export default {
  ...
  created() {
    this.dataTable = this.$store.state.executorRegistration.executors;
  },
  mounted() {
    this.isMounted = true;
  }
